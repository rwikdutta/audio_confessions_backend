from .views import AskViewSet,AnswerAskView,AddAskView,FromStudentAskFilterView,ToStudentAskFilterView,OrderedAskViewSet
from rest_framework.routers import DefaultRouter
from django.conf.urls import url,include
router=DefaultRouter()
router.register(r'ask',AskViewSet)
router.register(r'orderedask',OrderedAskViewSet)
