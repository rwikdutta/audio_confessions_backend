...
class SignUpSerializer(serializers.Serializer):
    ...
    passout_year=serializers.DecimalField(max_digits=4,decimal_places=0,allow_null=True,default=2019) #temp_hack...at the last moment it was decided not to take this information from the user, so it's always now filled in with a dummy value ( 2019 )
